        ...
        <header class="header_section" >
            ...
            <nav class="navbar navbar-expand-lg custom_nav-container ">
                ...
                <ul class="navbar-nav  mx-auto ">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" id="hal" href="#section1">Menu</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" id="hal" href="#section2">About</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" id="hal" href="#section3">Book Table</a>
                    </li>
                </ul>
        ...
        <div class="container">
            ...
            <div class="row grid">
                ...
                <div class="box">
                    <div>
                    <div class="img-box">
                        <img src="{{ asset('libs/web/images/f1.png') }}" alt="">
                    </div>
                ...
                <div class="box">
                    <div>
                    <div class="img-box">
                        <img src="{{ asset('libs/web/images/f2.png') }}" alt="">
                    </div>
                    <div class="detail-box">
                        <h5>
                        Delicious Burger
                ...
                <div class="box">
                    <div>
                    <div class="img-box">
                        <img src="{{ asset('libs/web/images/f3.png') }}" alt="">
                    </div>
                    <div class="detail-box">
                        <h5>
                        Delicious Pizza
